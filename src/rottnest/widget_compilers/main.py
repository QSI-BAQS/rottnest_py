...
def test_comb_mapper(gate_obj, width, height, spacing=2):
...
def run(gate_obj=None, region_obj=None):
    ...
    strat.mapper = test_comb_mapper(gate_obj, temp_reg_region['width'], temp_reg_region['height']) # TODO gosc mapper
